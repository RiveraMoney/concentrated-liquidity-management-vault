...
import "./interfaces/IV3SwapRouterAgni.sol";
...
contract RiveraConcNoStaking is FeeManager, ReentrancyGuard, ERC721Holder, Initializable {
    ...
    function _swapV3In(
        ...
        amountOut = IV3SwapRouterAgni(router).exactInputSingle(
            IV3SwapRouterAgni.ExactInputSingleParams(
                tokenIn,
                tokenOut,
                fee,
                address(this),
    ...
    function _swapV3PathIn(
        ...
        amountOut = IV3SwapRouterAgni(router).exactInput(
            IV3SwapRouterAgni.ExactInputParams(
                path,
                address(this),
                block.timestamp,
                amountIn,
