...
contract DeployPublicVaultV2MantleMainnet is Script {
    ...
    address _stake = 0xEe12e312878B74b2C17D80516128D7868f80365B;//mainnet
    address _lpToken0=0x09Bc4E0D864854c6aFB6eB9A9cdF58aC190D0dF9;//mainnnet
    address _lpToken1=0xdEAddEaDdeadDEadDEADDEAddEADDEAddead1111;//mainnnet
    address depositToken=_lpToken0;
    int24 _tickLower = 179300 ;
    int24 _tickUpper = 225350 ;
    string _tokenName="RIV-02-05-A75";
    string _tokenSymbol="RIV-02-05-A75";
