...
contract CakeLpStakingV2Test is Test {
    ...
    address _stake = 0x6fe9E9de56356F7eDBfcBB29FAB7cd69471a4869;//uniswap(usdtbnb)  //Mainnet address of the CAKE-USDT LP Pool you're deploying funds to. It is also the ERC20 token contract of the LP token.
    address _chef = address(0);   //Address of the pancake master chef v2 contract on BSC mainnet
    address _factory = 0xdB1d10011AD0Ff90774D0C6Bb92e5C5c8b4461F7;//uniswap
    address _router = 0x13f4EA83D0bd40E75C8222255bc855a974568Dd4; //panckake
    address _nonFungiblePositionManager = 0x7b8A01B39D58278b5DE7e48c8449c9f4F5170613;///uniswap
    ...
    int24 _tickLower =-56140;
    int24 _tickUpper =-54160;
